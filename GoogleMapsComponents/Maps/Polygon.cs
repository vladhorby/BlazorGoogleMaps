...
namespace GoogleMapsComponents.Maps
{
	public class Polygon : JsObjectRef
	{
		...
		{
			_jsRuntime.InvokeAsync<bool>("googleMapPolygonJsFunctions.dispose",
																									_guid.ToString());
		}

		public async Task<MapEventListener> AddListener<TEventArgs>(string eventName, Action<TEventArgs> handler)
		{
			var guid = await _jsEventInterop.SubscribePolygonEvent(_guid.ToString(), eventName, handler);
